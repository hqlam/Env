...
#$ cygpath -w  "/cygdrive/e/DemandTec_IBM/hlam_DellLatitute/hlam/D/DTSource"
#$ cygpath -u  "E:\DemandTec_IBM\hlam_DellLatitute\hlam\D\DTSource"
alias cyg-get='/cygdrive/c/cygwin64/setup-x86_64.exe -q -P'
cmdstart () { fn=$1; cmd /c start $fn ; }
alias cmdst=' cmd /c start '
alias cs='    cygstart'
cslast() {    cygstart "$(/bin/ls -t *.* | head -1)" ; }
...
#$ echo `expr index "hello world" "yxae" ; return 2 as position of e
# echo ${#my_str} ; equiv $ echo `expr length "$my_str" `
# echo ${str:0:2} ; equiv $ echo `expr substr "$str" 1 2 `
# $ echo `expr match "$str" '.*wo' ` ; return 8 as position of o
