...
url     = "https://api.webpa.comcast.net:8090" + '/api/v2/device/' + "mac:" + mac + "/config?names=Device.DeviceInfo.X_COMCAST-COM_WAN_IP,Device.DeviceInfo.Webpa.X_COMCAST-COM_CMC,Device.DeviceInfo.Webpa.X_COMCAST-COM_CID"
print url
